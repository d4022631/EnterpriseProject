...
namespace BookingBlock.WebApplication.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,ServiceId,Rating,Comments")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,ServiceId,Rating,Comments")] Review review)
        {
            if (ModelState.IsValid)
            {
